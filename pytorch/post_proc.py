...
conf['dataDir'] = "/scratch/daep/e.ajuria/FluidNet/OriginalFluid/FluidNet/manta/output/Open_plume"
conf['dataset'] = conf['dataDir'] + '/000001'
...
tr = lib.FluidNetDataset(conf, '', save_dt=4, resume=resume)
